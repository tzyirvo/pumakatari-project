...
export const isUserLoggedIn = createSelector(
  getUserState,
  userReducer.isUserLoggedIn
);
export const isNotUserLoggedIn = createSelector(
  getUserState,
  userReducer.isNotUserLoggedIn
);
export const getUserEmail = createSelector(
  getUserState,
  userReducer.getUserEmail
);
...
export const getCurrentLocation = createSelector(
  getDbState,
  dbReducer.getCurrentLocation
);

export const getMessagesState = (state: State) => state.messages;

export const showSuccessMessage = createSelector(
  getMessagesState,
  messagesReducer.showSuccessMessage
);
export const showErrorMessage = createSelector(
  getMessagesState,
  messagesReducer.showErrorMessage
);
export const getSuccessMessage = createSelector(
  getMessagesState,
  messagesReducer.getSuccessMessage
);
export const getErrorMessage = createSelector(
  getMessagesState,
  messagesReducer.getErrorMessage
);
